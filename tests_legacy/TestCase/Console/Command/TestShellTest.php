...
class TestShellTest extends CakeTestCase
{
    ...
    public function testMapCoreFileToCategory()
    {
        ...
        $return = $this->Shell->mapFileToCategory('src/Cake/basics.php');
        $this->assertSame('core', $return);

        $return = $this->Shell->mapFileToCategory('src/Cake/Core/App.php');
        $this->assertSame('core', $return);

        $return = $this->Shell->mapFileToCategory('src/Cake/Some/Deeply/Nested/Structure.php');
        $this->assertSame('core', $return);
    }
    ...
    public function testMapCoreFileToCase()
    {
        ...
        $return = $this->Shell->mapFileToCase('src/Cake/basics.php', 'core');
        $this->assertSame('Basics', $return);

        $return = $this->Shell->mapFileToCase('src/Cake/Core/App.php', 'core');
        $this->assertSame('Core/App', $return);

        $return = $this->Shell->mapFileToCase('src/Cake/Some/Deeply/Nested/Structure.php', 'core', false);
    ...
    public function testMapCoreTestToCategory()
    {
        ...
        $return = $this->Shell->mapFileToCategory('tests_legacy/TestCase/BasicsTest.php');
        $this->assertSame('core', $return);

        $return = $this->Shell->mapFileToCategory('tests_legacy/TestCase/BasicsTest.php');
        $this->assertSame('core', $return);

        $return = $this->Shell->mapFileToCategory('tests_legacy/TestCase/Some/Deeply/Nested/StructureTest.php');
        $this->assertSame('app', $return);
    }
    ...
    public function testMapCoreTestToCase()
    {
        ...
        $return = $this->Shell->mapFileToCase('tests_legacy/TestCase/BasicsTest.php', 'core');
        $this->assertSame('Basics', $return);

        $return = $this->Shell->mapFileToCase('tests_legacy/TestCase/Core/AppTest.php', 'core');
        $this->assertSame('Core/App', $return);

        $return = $this->Shell->mapFileToCase('tests_legacy/TestCase/Some/Deeply/Nested/StructureTest.php', 'core', false);
        $this->assertSame('Some/Deeply/Nested/Structure', $return);
    }
