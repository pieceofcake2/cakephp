...
class TestShellTest extends CakeTestCase
{
    ...
    public function testMapCoreTestToCategory()
    {
        ...
        $return = $this->Shell->mapFileToCategory('tests/Case/BasicsTest.php');
        $this->assertSame('core', $return);

        $return = $this->Shell->mapFileToCategory('tests/Case/BasicsTest.php');
        $this->assertSame('core', $return);

        $return = $this->Shell->mapFileToCategory('tests/Case/Some/Deeply/Nested/StructureTest.php');
        $this->assertSame('app', $return);
    }
    ...
    public function testMapCoreTestToCase()
    {
        ...
        $return = $this->Shell->mapFileToCase('tests/Case/BasicsTest.php', 'core');
        $this->assertSame('Basics', $return);

        $return = $this->Shell->mapFileToCase('tests/Case/Core/AppTest.php', 'core');
        $this->assertSame('Core/App', $return);

        $return = $this->Shell->mapFileToCase('tests/Case/Some/Deeply/Nested/StructureTest.php', 'core', false);
        $this->assertSame('Some/Deeply/Nested/Structure', $return);
    }
