...
class HttpSocketTest extends CakeTestCase
{
    ...
    public function testRequestWithConstructor()
    {
        ...
        $http->expects($this->exactly(2))
            ->method('request')
            ->withConsecutive(
                [['method' => 'GET', 'uri' => 'http://localhost:5984/_test']],
                [['method' => 'GET', 'uri' => 'http://localhost:5984/_test?count=4']],
            );
    ...
    public function testRequestWithCrossCookie()
    {
        ...
        $this->Socket->expects($this->any())
            ->method('read')
            ->willReturnCallback(function () use (&$readCounter) {
                $responses = [
                    "HTTP/1.x 200 OK\r\nSet-Cookie: foo=bar\r\nDate: Mon, 16 Apr 2007 04:14:16 GMT\r\nServer: CakeHttp Server\r\nContent-Type: text/html\r\n\r\n<h1>This is a test!</h1>",
                    false,
                    "HTTP/1.x 200 OK\r\nSet-Cookie: bar=foo\r\nDate: Mon, 16 Apr 2007 04:14:16 GMT\r\nServer: CakeHttp Server\r\nContent-Type: text/html\r\n\r\n<h1>This is a test!</h1>",
    ...
    public function testRequestWithRedirectUrlEncoded()
    {
        ...
        $this->assertStringContainsString('Host: i.cmpnet.com', $writeCalls[1]);
        $this->assertStringContainsString('GET /techonline/pdf/a+b.pdf', $writeCalls[1]);
    ...
    public function testGet()
    {
        ...
        $this->RequestSocket->expects($this->exactly(7))
            ...
            ->withConsecutive(
                ...
                [['method' => 'GET', 'uri' => 'http://www.google.com/?foo=bar']],
                [['method' => 'GET', 'uri' => 'http://www.google.com/?foo=bar']],
                [['method' => 'GET', 'uri' => 'http://www.google.com/?foo=23&foobar=42']],
                [['method' => 'GET', 'uri' => 'http://www.google.com/', 'version' => '1.0']],
                [['method' => 'GET', 'uri' => 'https://secure.example.com/test.php?one=two']],
                [['method' => 'GET', 'uri' => 'https://example.com/oauth/access?clientid=123&redirect_uri=http%3A%2F%2Fexample.com&code=456']],
            );
    ...
    public function testHead()
    {
        ...
        $this->RequestSocket->expects($this->exactly(7))
            ->method('request')
            ->withConsecutive(
                [['method' => 'HEAD', 'uri' => 'http://www.google.com/']],
                [['method' => 'HEAD', 'uri' => 'http://www.google.com/?foo=bar']],
                [['method' => 'HEAD', 'uri' => 'http://www.google.com/?foo=bar']],
                [['method' => 'HEAD', 'uri' => 'http://www.google.com/?foo=23&foobar=42']],
                [['method' => 'HEAD', 'uri' => 'http://www.google.com/', 'version' => '1.0']],
                [['method' => 'HEAD', 'uri' => 'https://secure.example.com/test.php?one=two']],
                [['method' => 'HEAD', 'uri' => 'https://example.com/oauth/access?clientid=123&redirect_uri=http%3A%2F%2Fexample.com&code=456']],
            );
    ...
    public function testAuth()
    {
        ...
        $this->assertTrue(str_contains($this->Socket->request['header'], 'Authorization: Basic bWFyazpzZWNyZXQ='));
        ...
        $this->Socket->get('http://example.com/test');
        $this->assertTrue(str_contains($this->Socket->request['header'], 'Authorization: Test mark.passwd'));
        ...
        $this->assertTrue(str_contains($this->Socket->request['header'], 'Authorization: Basic am9lbDpodW50ZXIy'));
    ...
    public function testPost()
    {
        ...
        $this->RequestSocket->expects($this->exactly(3))
            ->method('request')
            ->withConsecutive(
                [['method' => 'POST', 'uri' => 'http://www.google.com/', 'body' => []]],
                [['method' => 'POST', 'uri' => 'http://www.google.com/', 'body' => ['Foo' => 'bar']]],
                [['method' => 'POST', 'uri' => 'http://www.google.com/', 'body' => null, 'line' => 'Hey Server']],
            );
    ...
    public function testPut()
    {
        ...
        $this->RequestSocket->expects($this->exactly(3))
            ->method('request')
            ->withConsecutive(
                [['method' => 'PUT', 'uri' => 'http://www.google.com/', 'body' => []]],
                [['method' => 'PUT', 'uri' => 'http://www.google.com/', 'body' => ['Foo' => 'bar']]],
                [['method' => 'PUT', 'uri' => 'http://www.google.com/', 'body' => null, 'line' => 'Hey Server']],
            );
    ...
    public function testPatch()
    {
        ...
        $this->RequestSocket->expects($this->exactly(3))
            ->method('request')
            ->withConsecutive(
                [['method' => 'PATCH', 'uri' => 'http://www.google.com/', 'body' => []]],
                [['method' => 'PATCH', 'uri' => 'http://www.google.com/', 'body' => ['Foo' => 'bar']]],
                [['method' => 'PATCH', 'uri' => 'http://www.google.com/', 'body' => null, 'line' => 'Hey Server']],
            );
    ...
    public function testDelete()
    {
        ...
        $this->RequestSocket->expects($this->exactly(3))
            ->method('request')
            ->withConsecutive(
                [['method' => 'DELETE', 'uri' => 'http://www.google.com/', 'body' => []]],
                [['method' => 'DELETE', 'uri' => 'http://www.google.com/', 'body' => ['Foo' => 'bar']]],
                [['method' => 'DELETE', 'uri' => 'http://www.google.com/', 'body' => null, 'line' => 'Hey Server']],
            );
    ...
    public function testVerifyPeer()
    {
        ...
        try {
            ...
            $this->skipIf(str_contains($message, 'Invalid HTTP'), 'Invalid HTTP Response received, skipping.');
