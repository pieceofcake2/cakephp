...
class Sanitize
{
     ...
     *
     * @param array|string $string String to sanitize
     * @param array $allowed An array of additional characters that are not to be removed.
     * @return array|string Sanitized string
     */
     ...
     * @param array|string $options If string, DB connection being used, otherwise set of options
