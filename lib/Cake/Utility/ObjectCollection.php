...
abstract class ObjectCollection
{
     ...
     *    Defaults to false.
     *
     * @param CakeEvent|string $callback Method to fire on all the objects. Its assumed all the objects implement
     ...
     *
     * @param array|string $name CamelCased name of the object(s) to enable (string or array)
