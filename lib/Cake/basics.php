...
if (!function_exists('clearCache')) {
     ...
     *
     * @param array|string $params As String name to be searched for deletion, if name is a directory all files in
...
if (!function_exists('fileExistsInPath')) {
     ...
     * @return string|bool Full path to file if exists, otherwise `false`.
