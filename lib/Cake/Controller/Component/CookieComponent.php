...
class CookieComponent extends Component
{
     ...
     *
     * @param array|string $key Key for the value
     * @param mixed $value Value
     * @param bool $encrypt Set to true to encrypt value, false otherwise
     * @param string|int $expires Can be either the number of seconds until a cookie
     ...
     * @return array|string|null Value for specified key
     ...
     *
     * @param string|int $expires Can be either Unix timestamp, or date string
     ...
     * @return array|string Decoded value.
     */
