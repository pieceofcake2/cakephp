...
class HtmlHelper extends AppHelper
{
     ...
     * @param array|string $options Link attributes e.g. array('id' => 'selected')
     * @return self
     ...
     *
     * @param array|string $configFile String with the config file (load using PhpReader) or an array with file and reader name
