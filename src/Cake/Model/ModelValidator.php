...
class ModelValidator implements ArrayAccess, IteratorAggregate, Countable
{
    ...
    protected function _triggerBeforeValidate($options = [])
    {
        ...
        [$event->break, $event->breakOn] = [true, false];
     ...
     * @param CakeValidationSet|array $rules set of rules to apply to field
     * @return void
     */
     ...
     * @param CakeValidationSet|array|string $name name of the rule to be added or list of rules for the field
     * @param CakeValidationRule|array $rule or list of rules to be added to the field's rule set
     * @return self
     */
