...
class App
{
     ...
     * @param string|bool $mode App::RESET will set paths, App::APPEND with append paths, App::PREPEND will prepend paths (default)
    ...
    public static function load($className)
    {
        ...
        if (class_exists(LegacyClassLoader::class, false)) {
        ...
        [$plugin, $package] = count($parts) > 1 ? $parts : [null, current($parts)];
    ...
    {
        if ($plugin !== null) {
            return [CakePlugin::classPath($plugin) . $type . DS];
        }
