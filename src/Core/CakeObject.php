...
class CakeObject
{
     ...
     */
    public function dispatchMethod(string $method, array $params = []): mixed
    {
     ...
     *
     * @param array|string|null $properties An associative array containing properties and corresponding values.
     * @return void
     */
    protected function _set(array|string|null $properties = []): void
    {
     ...
     * @return void
     */
    protected function _mergeVars(array $properties, string $class, bool $normalize = true): void
    {
